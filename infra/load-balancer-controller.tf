...
# adds issuer to the list of trusted OIDC providers for the AWS account to IAM
# without this, the IAM role for the AWS Load Balancer Controller cannot be assumed by the service account in the EKS cluster
...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  name   = "${local.eks_cluster_name}-load-balancer-controller"
